#
#  Be sure to run `pod spec lint FSAttributedString.podspec' to ensure this is a
...
FSAttributedString是一个轻量级的字符拼接工具，它以更好的语法包装了NSAttributedString。 拥有自己的属性字符模型，通过包含关系有效避免NSRange的一致性问题，链式调用，从而使布局代码更简洁易读。暂不支持Label的链接点击。
  ...
  # Or just: s.author    = "zhangzhongyan"
  # s.authors            = { "zhangzhongyan" => "749994100@qq.com" }
  # s.social_media_url   = "http://twitter.com/zhangzhongyan"
  ...
  s.source       = { :git => "https://github.com/zhangzhongyan/FSAttributedString.git", :tag => "#{s.version}" }
